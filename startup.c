...
void set_sysclk_pll(void)
{
	...
	//set flash wait state = 0
	WRITE_BITS(FLASH_BASE+FLASH_ACR_OFFSET, LATENCY_2_BIT, LATENCY_0_BIT, 0b000);
	//use HSE
	...
	//enable HSI
	SET_BIT(RCC_BASE+RCC_CR_OFFSET, 0);
	...
	WRITE_BITS(RCC_BASE + RCC_PLLCFGR_OFFSET, PLLN_8_BIT, PLLN_0_BIT, 84);
